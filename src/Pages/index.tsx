          ...
          <section className={styles.sectionSecond}>
            ...
            <div className={styles.sectionSecondData}>
              ...
              <p>
                ...
                asegurada. Además, te ofrecemos una variedad de comidas, cervezas y cócteles en un ambiente increíble. ¡Te esperamos para vivir momentos
                geniales! Es el plan perfecto <strong>para vos</strong>. ¡No te lo podés perder!
              </p>
            </div>
          </section>
